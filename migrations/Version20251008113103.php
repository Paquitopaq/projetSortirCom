 ...
 */
final class Version20251008113103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, site_id INT DEFAULT NULL, lieu_id INT DEFAULT NULL, id_sortie VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, date_heure_debut DATETIME DEFAULT NULL, duree INT NOT NULL, date_limite_inscription DATETIME NOT NULL, nb_inscription_max INT NOT NULL, info_sortie VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_3C3FD3F2F6BD1646 (site_id), INDEX IDX_3C3FD3F26AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
